...
TITLE_IMAGE = pygame.image.load(os.path.join('', 'Title.png'))
TITLE_IMAGE_MODIFIED = pygame.transform.scale(TITLE_IMAGE, (WIDTH * 0.4, HEIGHT * 0.3))
TEST_TUBE_ROW_IMAGE = pygame.image.load(os.path.join('', 'TestTubeGame_TestTubeRow.png'))
TEST_TUBE_OPENING_SCREEN_IMAGE = pygame.transform.scale(TEST_TUBE_ROW_IMAGE, (WIDTH, HEIGHT))
TEST_TUBE_IMAGE = pygame.image.load(os.path.join('', 'test_tube_better.jpeg'))
DIFFICULTY_RAW = pygame.image.load(os.path.join('', 'Difficulty.png'))
NUMBER_OF_UNDOS_RAW = pygame.image.load(os.path.join('', 'Number_of_Undos.png'))
...
TUBE_RAW = pygame.image.load(os.path.join('', 'Tube.png'))
TUBE1_RAW = pygame.image.load(os.path.join('', 'Tube1.png'))
TUBE2_RAW = pygame.image.load(os.path.join('', 'tube2.png'))
TUBE3_RAW = pygame.image.load(os.path.join('', 'tube3.png'))
TUBE4_RAW = pygame.image.load(os.path.join('', 'tube4.png'))
WON_RAW = pygame.image.load(os.path.join('', 'You_Win.png'))
AMONGUS_RAW = pygame.image.load(os.path.join('', 'Amongus.jpeg'))
CONFET_RAW = pygame.image.load(os.path.join('', 'confet.jpeg'))
HAROLD_RAW = pygame.image.load(os.path.join('', 'harold.png'))
STONKS_RAW = pygame.image.load(os.path.join('', 'stonks.png'))
FORNITE_RAW = pygame.image.load(os.path.join('', 'plzbepng.png'))
...
CONTROLS_RAW = pygame.image.load(os.path.join('', 'Controls.png'))
INSTRUCTIONS_RAW = pygame.image.load(os.path.join('', 'Instructions.png'))
...
BRICK_RAW = pygame.image.load(os.path.join('', 'bricks.jpeg'))
BRICK_MODIFIED = pygame.transform.scale(BRICK_RAW,(WIDTH, HEIGHT))



LAB_RAW = pygame.image.load(os.path.join('', 'lab.png'))
